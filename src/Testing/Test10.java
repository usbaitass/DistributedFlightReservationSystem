...
public class Test10 {
	...
	public static void beforeClass() {
		System.out.println("Before Class Test10");		
	}
	@AfterClass 
	public static void  afterClass() {
		System.out.println("After Class Test10");
	}
	...
	public void testGetBookedCountFlightFlights() throws InvalidName, NotFound, CannotProceed, org.omg.CosNaming.NamingContextPackage.InvalidName {
		...
		assertEquals("MTL;1;WST;0;NDL;1;", r1);
		assertEquals("MTL;2;WST;2;NDL;0;", r2);
		assertEquals("MTL;3;WST;2;NDL;3;", r3);
		assertEquals("MTL;6;WST;4;NDL;4;", r4);		
	}
