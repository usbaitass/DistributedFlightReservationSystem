...
public class Test5 {
	...
	public static void beforeClass() {
		System.out.println("Before Class Test5");		
	}
	@AfterClass 
	public static void  afterClass() {
		System.out.println("After Class Test5");
	}
	...
	public void testCreateFlight() throws InvalidName, NotFound, CannotProceed, org.omg.CosNaming.NamingContextPackage.InvalidName {
		...
		int r = Integer.parseInt(aBooking.editFlightRecord("MTL1111", "0;Washington;10October2016;20:30", ""));
		assertEquals(1, r);
