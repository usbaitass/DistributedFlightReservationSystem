...
public class Test3 {
	...
	@Test
	public void testGetBookedCountFlightWithNoFlightsYET() throws InvalidName, NotFound, CannotProceed, org.omg.CosNaming.NamingContextPackage.InvalidName {
		System.out.println("testGetBookedCountFlightWithNoFlightsYET()");
		...
		assertEquals("MTL;0;WST;0;NDL;0;", r1);
		assertEquals("MTL;0;WST;0;NDL;0;", r2);
		assertEquals("MTL;0;WST;0;NDL;0;", r3);
		assertEquals("MTL;0;WST;0;NDL;0;", r4);	
	}
