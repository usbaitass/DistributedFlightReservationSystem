...
public class Test23 {
	...
	public static void beforeClass() {
		System.out.println("Before Class Test23");		
	}
	@AfterClass 
	public static void  afterClass() {
		System.out.println("After Class Test23");
	}
	...
	public void test2() throws InvalidName, NotFound, CannotProceed, org.omg.CosNaming.NamingContextPackage.InvalidName {
		...
		Passenger p = new Passenger("Ayan", "Baitassov", "Verdun", "514", "Montreal", "Washington", "business", DATE+"November2016", "123");
	...
	public void test3() throws InvalidName, NotFound, CannotProceed, org.omg.CosNaming.NamingContextPackage.InvalidName {
		...
		Passenger p = new Passenger("Aida", "Baitassov", "Verdun", "514", "Montreal", "Washington", "business", DATE+"November2016", "123");
