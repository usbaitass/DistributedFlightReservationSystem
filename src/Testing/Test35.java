...
public class Test35 {
	...
	public static void beforeClass() {
		System.out.println("Before Class Test35");		
	}
	@AfterClass 
	public static void  afterClass() {
		System.out.println("After Class Test35");
	}
	...
	public void testTransferReservation() throws InvalidName, NotFound, CannotProceed, org.omg.CosNaming.NamingContextPackage.InvalidName {
		...
		String passengerID = "";
		try {
			scanner = new Scanner(new File("id.txt"));
