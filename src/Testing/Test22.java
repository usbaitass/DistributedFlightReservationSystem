...
public class Test22 {
	...
	public static void beforeClass() {
		System.out.println("Before Class Test22");		
	}
	@AfterClass 
	public static void  afterClass() {
		System.out.println("After Class Test22");
	}
	...
	public void testCreateFlight() throws InvalidName, NotFound, CannotProceed, org.omg.CosNaming.NamingContextPackage.InvalidName {
		...
		int r = Integer.parseInt(aBooking.editFlightRecord("NDL1111", "0;Washington;"+DATE+"November2016;20:30", ""));
		assertEquals(1, r);
